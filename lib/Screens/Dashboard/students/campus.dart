                              ...
                              child: SizedBox(
                                ...
                                child: Column(
                                    ...
                                    children: [
                                      ...
                                      const Text("KMC"),
                                      const Text("Music Club",style: TextStyle(color: Colors.red,fontSize: 12),),
                                      const Icon(Icons.keyboard_arrow_down,color: Colors.grey,),
                                    ]),
                              )),
                          Card(
                            ...
                            child: SizedBox(
                              ...
                              child: Column(
                                ...
                                children: [
                                  ...
                                  const Text("TEDx"),
                                  const Text("Club",style: TextStyle(color: Colors.red,fontSize: 12),),
                                  const Icon(Icons.keyboard_arrow_down,color: Colors.grey,),
                                ],
                              ),
                            ),
                              ...
                              child: SizedBox(
                                ...
                                child: Column(
                                    ...
                                    children: [
                                      ...
                                      const Text("Dance Club",style: TextStyle(color: Colors.red,fontSize: 12),),
                                      const Icon(Icons.keyboard_arrow_down,color: Colors.grey,),
                                    ]),
                              )),
                          Card(
                              ...
                              child: SizedBox(
                                ...
                                child: Column(
                                    ...
                                    children: [
                                      ...
                                      const Text("Pharmacy KIET",style: TextStyle(color: Colors.red,fontSize: 12),),
                                      const Icon(Icons.keyboard_arrow_down,color: Colors.grey,),
                                    ]),
                              )),
                          Card(
                        ...
                        children: [
                          GestureDetector(
                            onTap: () => Navigator.push(
                              context,
                              MaterialPageRoute(
                                builder: (context) => const ArticlePage(s: 'a2',),
                              ),
                            ),
                            child: Card(
                                color: Colors.white,
                                child: SizedBox(
                                  ...
                                  child: Column(
                                      ...
                                      children: [
                                        ...
                                        const Text("Report",style: TextStyle(color: Colors.red,fontSize: 12),),
                                        const Icon(Icons.keyboard_arrow_down,color: Colors.grey,),
                                      ]),
                                )),
                          ),
                          GestureDetector(
                            onTap: () => Navigator.push(
                              context,
                              MaterialPageRoute(
                                builder: (context) => const ArticlePage(s: 'a1',),
                              ),
                            ),
                            child: Card(
                                color: Colors.white,
                                child: SizedBox(
                                  ...
                                  child: Column(
                                      ...
                                      children: [
                                        ...
                                        const Text("CM-Visit"),
                                        const Text("Article",style: TextStyle(color: Colors.red,fontSize: 12),),
                                        const Icon(Icons.keyboard_arrow_down,color: Colors.grey,),
                                      ]),
                                )),
                          ),
                          GestureDetector(
                            onTap: () => Navigator.push(
                              context,
                              MaterialPageRoute(
                                builder: (context) => const ArticlePage(s: 'a3',),
                              ),
                            ),
                            child: Card(
                              color: Colors.white,
                        ...
                        children: [
                          GestureDetector(
                            onTap: () => Navigator.push(
                              context,
                              MaterialPageRoute(
                                builder: (context) => const ArticlePage(s: 'a4',),
                              ),
                            ),
                            child: Card(
                                color: Colors.white,
                          ...
                          GestureDetector(
                            onTap: () => Navigator.push(
                              context,
                              MaterialPageRoute(
                                builder: (context) => const ArticlePage(s: 'a5',),
                              ),
                            ),
                            child: Card(
                                color: Colors.white,
                          ...
                          GestureDetector(
                            onTap: () => Navigator.push(
                              context,
                              MaterialPageRoute(
                                builder: (context) => const ArticlePage(s: 'a6',),
                              ),
                            ),
                            child: Card(
                              color: Colors.white,
