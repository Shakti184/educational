      ...
      body: Padding(
        ...
        child: Column(
          ...
          children: [
                           ...
                           CircleAvatar(
                            ...
                            ElevatedButton(
                                style: const ButtonStyle(
                                    ...
                                    onPressed: () {},
                                    child: const Text("Innotech-2023",style: TextStyle(color: Colors.white,fontSize: 13),)),
            ...
            const SizedBox(height: 30,),
            const Text("Latest Hirings",style: TextStyle(fontSize: 20),),
            Expanded(
              child: 
                 Column(
            ...
            ElevatedButton(
              ...
              onPressed: () {
                ...
                Navigator.pushAndRemoveUntil(
                    context,
                    MaterialPageRoute(
                        builder: ((context) => const StudentSignInPage())),(route)=>false);// Navigate to login
              },
            ),
          ],
        );
