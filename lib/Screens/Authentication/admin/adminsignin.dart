...
import 'package:edubridge/Screens/Dashboard/admin/admin_dashboard.dart';
...
class _AdminSignInPageState extends State<AdminSignInPage> {
  ...
  void _navigateToAdminSignup() {
    Navigator.pushAndRemoveUntil(
        context,
        MaterialPageRoute(builder: (contrxt) => const AdminSignupPage()),
        (route) => false);
  }
                        ...
                        TextButton(
                          ...
                          child: RichText(
                            text: const TextSpan(
                              ...
                              children: [
                                TextSpan(text: 'Create New Admin Account \n'),
                                TextSpan(
                                  text: 'Register Now',
                                  style: TextStyle(
                                    color: Colors.blue,
